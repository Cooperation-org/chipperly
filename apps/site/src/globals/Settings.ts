          ...
          fields: [
            {
              ...
              admin: { description: 'From clarity.microsoft.com > Settings > Overview. Empty falls back to the CLARITY_ID env var (ynqc1d26iw). Records on the live domain only: never on localhost, previews or in the admin.' },
            },
            {

...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_waitlist_role" AS ENUM('caregiver', 'professional', 'self', 'other');
  ...
  CREATE TABLE "exports" (
  	...
  	"collection_slug" varchar DEFAULT 'waitlist' NOT NULL,
  ...
  CREATE TABLE "settings" (
  	...
  	"launched" boolean,
  	"contact_email" varchar DEFAULT 'info@chipperlyapp.com',
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_waitlist_role";
